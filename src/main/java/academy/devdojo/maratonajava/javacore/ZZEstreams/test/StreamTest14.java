...
public class StreamTest14 {
  ...
  public static void main(String[] args) {
    ...
    Map<Category, LightNovel> collect3 =
        lightNovels.stream().collect(Collectors.toMap(
