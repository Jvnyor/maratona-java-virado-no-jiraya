...
public class StreamTest11 {
  private static List<LightNovel> lightNovels = new ArrayList<>(List.of(
      ...
      new LightNovel("Kumo desuga", 1.99), new LightNovel("Kumo desuga", 1.99),
  ...
  public static void main(String[] args) {
    ...
    System.out.println(lightNovels.stream().collect(
    ...
    DoubleSummaryStatistics collect = lightNovels.stream().collect(
